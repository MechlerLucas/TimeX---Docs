...
O Transtorno de Déficit de Atenção e Hiperatividade (TDAH), \citeonline{barkley2008} apud, é um transtorno neurobiológico caracterizado por dificuldades nas funções executivas, como planejamento, organização e autorregulação, o que frequentemente resulta em prejuízos acadêmicos, profissionais e sociais. Nesse contexto, a área de aplicativos móveis e ferramentas digitais de apoio vem se consolidando como uma alternativa promissora para auxiliar pessoas com esse perfil, oferecendo recursos que podem apoiar a organização pessoal de maneira prática e acessível.
